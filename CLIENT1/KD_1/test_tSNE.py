...
#file_path = "CLIENT1/output/model_client1.pkl"                       ##!
file_path = "CLIENT1/output/local_model_client1_24.pkl"
...
for i in range(3):                                     ##!
    ...
    if i == 0:        
        ...
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="Unhealthy")        
#plt.title("t-SNE visualization of test data features")
#plt.xlabel("t-SNE component 1")
#plt.ylabel("t-SNE component 2")
plt.axis('off')
plt.legend(loc='upper left')
plt.savefig("CLIENT1/output/tsne1-l.png", bbox_inches='tight', pad_inches=0)              ##!
plt.show()
