...
from model_client4 import NetS, NetT, train, val, test
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, trainloader, valloader, testloader, num_classes) -> None:
        ...
        self.local_file_path = "CLIENT4/output/local_model_client4.pkl" 
    ...
    def fit(self, parameters, config):                    #order 2.
        ...
        if os.path.isfile(self.local_file_path):        
            with open(self.local_file_path, 'rb') as file:
                client4_state_dict = pickle.load(file)
                self.model_l.load_state_dict(client4_state_dict, strict=True) 
        else:
