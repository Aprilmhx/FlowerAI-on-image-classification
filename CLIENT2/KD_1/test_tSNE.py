...
file_path = "CLIENT2/output/model_client2.pkl"                       ##!
#file_path = "CLIENT2/output/local_model_client2_14.pkl"
...
for i in range(3):                                     ##!
    indices = labels == i
    if i == 0:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="Healthy")  
    elif i == 1:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="Benign")
    else:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="Malignant")        
#plt.title("t-SNE visualization of test data features")
#plt.xlabel("t-SNE component 1")
#plt.ylabel("t-SNE component 2")
plt.axis('off')
plt.legend(loc='upper center')
plt.savefig("CLIENT2/output/tsne2-g.png")              ##!
plt.show()
