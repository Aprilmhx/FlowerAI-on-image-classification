...
file_path = "CLIENT4/output/model_client4.pkl"                       ##!
#file_path = "CLIENT4/output/local_model_client4_27.pkl"
...
for i in range(8):                                     ##!
    ...
    if i == 0:        
        ...
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="NV")
    elif i == 2:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="BCC")
    elif i == 3:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="AK")
    elif i == 4:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="BKL")
    elif i == 5:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="DF")
    elif i == 6:        
        plt.scatter(features_tsne[indices, 0], features_tsne[indices, 1], label="VASC")        
    else:        
...
plt.savefig("CLIENT4/output/tsne4-g.png")              ##!
plt.show()
